                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="bg-gray-100 text-gray-700 px-3 py-2 rounded-md hover:bg-gray-200 transition-colors text-sm flex-1 flex items-center justify-center"
                    >
                    ...
                    {quotation.status === 'DRAFT' && (
                      <button
                        ...
                        className="bg-white text-gray-700 border border-gray-300 px-3 py-2 rounded-md hover:bg-gray-50 transition-colors text-sm flex-1 flex items-center justify-center"
                      >
                        <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {quotation.status === 'DRAFT' && (
                      <button
                        ...
                        className="bg-red-600 text-white px-3 py-2 rounded-md hover:bg-red-700 transition-colors text-sm flex-1 flex items-center justify-center"
                      >
                        <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
